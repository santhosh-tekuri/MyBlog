...
public class MyScrollPaneLayout extends ScrollPaneLayout{
    ...
    public static void main(String[] args){
        ...
        JTable table = new JTable(new Object[][]{
                                  {"a11", "a22"},        //NOI18N
                                  {"b11", "b22"},        //NOI18N
        }, new String[]{"col1", "col2"});                //NOI18N
        table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        JScrollPane sp = new JScrollPane();
        sp.setLayout(new MyScrollPaneLayout());
        sp.setViewportView(table);
        sp.add(MyScrollPaneLayout.HORIZONTAL_LEFT, new MyPanel(Color.blue));
        sp.add(MyScrollPaneLayout.HORIZONTAL_RIGHT, new MyPanel(Color.red));
        sp.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        sp.add(MyScrollPaneLayout.VERTICAL_TOP, new MyPanel(Color.green));
        sp.add(MyScrollPaneLayout.VERTICAL_BOTTOM, new MyPanel(Color.magenta));
        sp.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        sp.setBorder(BorderFactory.createEmptyBorder());
        JFrame frame = new JFrame("Enhancing JScrollPane - santhosh@in.fiorano.com");
