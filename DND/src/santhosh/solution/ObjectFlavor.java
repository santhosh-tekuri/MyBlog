...
public class ObjectFlavor extends DataFlavor{
    ...
    public static void main(String[] args){
        ...
        ObjectFlavor employeeFlavor = new ObjectFlavor(Employee.class);
        System.err.println(personFlavor.equals(employeeFlavor)); // person is employee ? ---> false
        System.err.println(employeeFlavor.equals(personFlavor)); // employee is person ? ---> true
    }
}
